...
HD_PWD='C:/Users/fors2/generator_GPIO/generator_GPIO.runs/design_1_my_lfsr_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_my_lfsr_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_my_lfsr_0_1.tcl
